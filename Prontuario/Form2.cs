    ...
    public partial class Form2 : Form
    {
        ...
        private void Form2_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                CMMC.CommandText = "  select medico, data_consulta, exames, diagnostico, tratamento, medicamentos, resultado, data_retorno from consulta01 where medico='NEUROLOGIA'"; 

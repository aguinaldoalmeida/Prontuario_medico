...
{
    public partial class ORTO_grid : Form
    {
        public ORTO_grid()
        {
            InitializeComponent();
        ...
        private void ORTO_grid_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                CMMC.CommandText = "  select medico, data_consulta, exames, diagnostico, tratamento, medicamentos, resultado, data_retorno from consulta01 where medico='ORTOPEDIA'";

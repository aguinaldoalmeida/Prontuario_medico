...
{
    public partial class DERMA_grid : Form
    {
        public DERMA_grid()
        {
            InitializeComponent();
        ...
        private void DERMA_grid_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                CMMC.CommandText = " select medico, data_consulta, exames, diagnostico, tratamento, medicamentos, resultado, data_retorno from consulta01 where medico='DERMATOLOGIA'";
